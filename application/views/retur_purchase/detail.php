    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Detail Return Purchase</small>
            </h1>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Return Purchase Detail <?php echo $details[0]->id;?></h3>
                            <div class="pull-right">
                                <span><a href="<?php echo site_url('retur_purchase');?>" class="btn btn-sm btn-danger">Back</a></span>
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $details[0]->return_by == 1 ? "Money" : "Goods";?></td>
