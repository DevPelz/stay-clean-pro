      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="<?php echo site_url('penjualan/create');?>">Add Sales</a></li>
            <li role="presentation"><a href="<?php echo site_url('penjualan');?>">Sales List</a></li>
          </ul>
            ...
            <?php } ?>
              ...
              <div class="box-footer">
                <div class="col-md-3 col-md-offset-4">
                  <a class="btn btn-danger" href="<?php echo site_url('penjualan');?>">Cancel</a>
